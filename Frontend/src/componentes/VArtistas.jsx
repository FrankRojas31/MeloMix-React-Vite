  ...
  return (
    <>
      <div class="relative overflow-x-auto sm:rounded-lg mt-10 w-[90%]">
          <h1 className="w-full text-[30px] font-bold mb-3">Artistas: <i class="nf nf-fa-plus_circle text-[30px] text-[#090] cursor-pointer" onClick={() => redirigir(<MArtista />)}></i></h1>
                ...
                return (
                  <tr class="border-x-1 border-y-0 bg-white hover:bg-[#eee]" key={valor}>
                    ...
                    <td class="text-black border-0 flex gap-10 justify-center">
                        <i class="nf nf-md-lead_pencil text-[30px] text-[#bb4] cursor-pointer " onClick={() =>{redirigir(<EArtistas components={components}/>); localStorage.setItem("id", valor);}}></i>
