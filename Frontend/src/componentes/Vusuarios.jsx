  ...
  return (
    <>
      <div class="relative overflow-x-auto sm:rounded-lg mt-10 w-[90%]">
          <h1 className="w-full text-[30px] font-bold mb-3 flex place-content-between items-center">Usuarios <i class="nf nf-fa-plus_circle text-[30px] text-[#090] cursor-pointer" onClick={() => redirigir(<MUsuario />)}></i></h1>
